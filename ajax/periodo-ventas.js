...
$(document).ready(function() {
    ...
    $("#btn-filtrar-reporte").click(function(){
        ...
        if( (val_periodo == "MONTH" && val_mes != "" && val_year != "" ) || (val_periodo == "YEAR" && val_year != "" ) ) {
            Swal.fire({
            ...
            get_data_report(period_val,period_mes,period_year);
            setTimeout(function(){
                Swal.close();
            },500);
        }
    ...
    $("#btn-reiniciar").click(function(){
        ...
        $('select[name="reporte_periodo"]').focus();
    ...
    function get_data_report(period_val,period_mes,period_year) {
    $.post(
      "../../modules/reportes/cargar-reporte-ventas-x-periodo.php", { PERIODO:period_val, MONTH:period_mes, YEAR:period_year }, 
      function(data) {
        ...
        var dataset = [
          { label: "Ventas por periodo", data: only_data, color: "#5482FF" }
        ];
