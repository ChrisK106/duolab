...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-04-2020 a las 00:32:57
...
--
-- Base de datos: `bd_duolab`
--
CREATE DATABASE IF NOT EXISTS `bd_duolab` DEFAULT CHARACTER SET latin1 COLLATE latin1_spanish_ci;
USE `bd_duolab`;
...
(4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'ESG PERÚ', '', '', '994734077', 'CALLAO', '07', '0701', '070101', '', '', '', '', 0, '2020-03-16 00:00:00'),
(5, '20125121542', 'NUEVO MUNDO SAC', 'MUNDO SOLUTIONS', '', '5612548', '952145687', 'LIMA', '15', '1501', '150113', '', '', '', '', 0, '2020-03-23 00:00:00');
...
(2, 'Christian', 'Cano', 'Alor', 'DNI', '71701773', 'Viudo', 'christian_k106@hotmail.com', '994734077', 'CALLAO', 'Secretario', 'Bachiller', 'Ingeniería de Software', '1994-01-09', '2020-03-02'),
(3, 'Diego', 'Palpa', 'Galarcep', 'DNI', '71024587', 'Soltero', '', '', 'SURCO', 'Visitador', 'Actualmente cursando', '', '1995-02-25', '2020-03-21'),
(4, 'Angel', 'Laos', 'Valencia', 'DNI', '71002545', 'Soltero', '', '', 'LIMA', 'Secretario', '', '', '1995-03-15', '2020-03-23'),
(5, 'Michel', 'Vargas', 'Barbarán', 'DNI', '1637624', 'Soltero', '1637624@utp.edu.pe', '', 'Lima', 'Visitador', 'Bachiller', 'Ingeniería de Sistemas', '1995-01-01', '2020-04-02');
...
INSERT INTO `tbl_invoice` (`id`, `number`, `status`, `quotation_id`, `customer_id`, `ruc`, `name`, `address`, `reference`, `payment_days`, `date`, `delivery_date`, `currency`, `discount_rate`, `discount_value`, `total_sub`, `total_tax`, `total_net`, `seller_id`, `user_id`, `registration_date`, `last_update`) VALUES
(1, 'F001-0000001', 2, 8, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 17, '2020-03-30', '2020-03-30', 'MN', 0, 0, 100, 18, 118, 1, 1, '2020-04-02 22:25:22', '2020-04-02 22:25:22'),
(2, 'F001-0000002', 2, 7, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 50, '2020-03-30', '2020-03-30', 'MN', 0, 0, 2490, 448.2, 2938.2, 12, 1, '2020-04-02 22:27:00', '2020-04-02 22:27:00'),
(3, 'F001-0000003', 1, 0, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 0, '2020-04-02', '2020-04-02', 'MN', 0, 0, 150, 27, 177, 1, 1, '2020-04-02 22:33:05', '2020-04-02 22:33:05'),
(4, 'F001-0000004', 1, 8, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 17, '2020-03-30', '2020-03-30', 'MN', 0, 0, 241, 43.38, 284.38, 1, 3, '2020-04-02 22:38:54', '2020-04-02 22:38:54'),
(5, 'F001-0000005', 1, 0, 5, '20125121542', 'NUEVO MUNDO SAC', 'LIMA', '', 15, '2020-04-02', '2020-04-02', 'MN', 0, 0, 25, 4.5, 29.5, 3, 3, '2020-04-02 22:40:59', '2020-04-02 22:40:59');
...
(1, 3, 10, 'MCAOR0001', '', 3, 50, 'PRODUCT AORUS 1'),
(2, 4, 11, 'MCAOR0002', '', 2, 120.5, 'PRODUCT AORUS 2'),
(3, 5, 8, 'AST0002', 'PRODUCTO EXCLUSIVO', 5, 5, 'PRODUCT STAR 2');
...
(9, 1, 'OC-1', 'Anulado', 'MN', '2020-04-02', '2020-04-02', 1, 0, '', '', 'SOLICITANTE', 'AUTORIZADOR', '', 246, 44.28, 290.28, 0, 0),
(10, 2, 'OS-1', 'Anulado', 'MN', '2020-04-02', '2020-04-02', 1, 35, '192-214564894-12-123', '', 'SOLICITANTE', 'AUTORIZADOR', '', 1577.25, 283.9, 1861.15, 0, 0);
...
--
-- Volcado de datos para la tabla `tbl_order_detail`
--

INSERT INTO `tbl_order_detail` (`id`, `order_id`, `item_code`, `item_description`, `item_gloss`, `item_unit_value`, `item_unit_price`, `item_quantity`, `item_discount_rate`, `item_discounted_total`) VALUES
(24, 9, 'asdasdasd', 'asdsa', 'asdsadsad', 'Galón', 23, 2, 0, 46),
(25, 9, 'sddsfd', 'dsf', 'sdfsdf', 'Galón', 100, 2, 0, 200),
(26, 10, '', 'QWERTY', 'QWERTY ASDF', '', 150, 7, 0, 1050),
(27, 10, '', 'GHJKL', 'ASDFGHJ CVBZXCZX', '', 55.5, 10, 5, 527.25);
...
INSERT INTO `tbl_product` (`id`, `code`, `brand`, `name`, `description`, `stock_quantity`, `unit_price`, `unit_value`, `provider_id`, `expiration_date`, `active_status`, `registration_date`) VALUES
(7, 'AST0001', 'STAR', 'PRODUCT STAR 1', 'PRODUCTO EXCLUSIVO', 1996, 2, 'Mililitros', 1, '2020-03-25', 1, '2020-03-25 21:26:39'),
(8, 'AST0002', 'STAR', 'PRODUCT STAR 2', 'PRODUCTO EXCLUSIVO', 1195, 5, 'Litros', 1, '2020-03-29', 1, '2020-03-29 22:16:46'),
(9, 'AST0003', 'STAR', 'PRODUCT STAR 3', 'STAR DOCTOR KIT', 50, 150, '', 1, '2020-03-29', 1, '2020-03-29 22:21:14'),
(10, 'MCAOR0001', 'AORUS', 'PRODUCT AORUS 1', '', 55, 50, '', 2, '2020-11-29', 1, '2020-03-29 22:31:59'),
(11, 'MCAOR0002', 'AORUS', 'PRODUCT AORUS 2', '', 44, 120.5, '', 2, '2020-08-13', 1, '2020-03-29 22:33:26');
...
(1, '20212315646546', 'AEGIS', 'CALLE AMAZONAS 123', 'PERU', 'LIMA', 'CALLAO', '', '', '', '', '', '', '', '', '', '', '', '', '2020-03-29 22:29:33'),
(2, '20102548912', 'MEDIC CORP SAC', 'Av. La Marina 2250', 'Perú', 'Lima', 'San Miguel', '', '', '', '', '', '', '', '', '', '', '', '', '2020-03-29 22:23:02');
...
(7, 'COTZ-1', 2, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 50, '2020-03-30', '2020-03-30', 'MN', 0, 0, 2482, 446.76, 2928.76, 12, 1, '2020-03-30 00:14:20', '2020-03-30 05:19:11'),
(8, 'COTZ-8', 2, 4, '20141234567', 'EMPIRE SOFT GROUP SAC', 'CALLAO', '', 17, '2020-03-30', '2020-03-30', 'MN', 0, 0, 18, 3.24, 21.24, 1, 3, '2020-03-30 01:19:39', '2020-03-30 05:07:35');
...
(70, 8, 7, 'PRODUCT STAR 1', 'PRODUCTO EXCLUSIVO', 2, 9),
(71, 7, 10, 'PRODUCT AORUS 1', '', 50, 40),
(72, 7, 11, 'PRODUCT AORUS 2', '', 120.5, 4);
...
(1, 'ccano', '$2y$10$RRhrmQfDdwxo7PqjUPcPVOxF9eYCohSMiYgv4f.0Mwq2yLb9Kc4Wq', 2, 'avatar5.png', '2020-03-08 21:46:47'),
(3, 'dpalpa', '$2y$10$/x5fgMCtXOVe.L834EStyOg.E3rB3nvLNSLAlA9ywhr86CwJxVdCS', 3, '', '2020-03-23 16:22:54'),
(12, 'gelus', '$2y$10$f3yIMCVq4Cu70v5464O0Bu6.9lvA1xAY56bZdR.sralfgDBbpWBpG', 4, 'gelus.jpg', '2020-03-27 19:21:33'),
(13, 'mvargas', '$2y$10$ydw8B/0zyvKyjvV.QhJ7DObLHEPceEUZECh4SUw5.M3S4B1nihGHO', 5, 'mvargas.jpg', '2020-04-02 20:00:46');
