...
$sqlStatement = $pdo->prepare("SELECT * FROM tbl_order $query_estado $query_tipo ORDER BY id DESC");
$sqlStatement->execute();
$rowsNumber = $sqlStatement->rowCount();
$DATA = array();
if ($rowsNumber > 0) {
    array_push($DATA, ["id"=>"","text"=>"Seleccione una orden"]);
    ...
    array_push($DATA, ["id"=>"","text"=>"No se han encontrado ordenes"]);
}
