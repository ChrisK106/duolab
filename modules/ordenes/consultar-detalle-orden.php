...
$sqlStatement = $pdo->prepare("SELECT item_code AS CODE, item_description AS DESCRIPTION, item_gloss AS GLOSS, item_unit_value AS UNIT_VALUE, item_unit_price AS UNIT_PRICE, item_quantity AS QUANTITY, item_discount_rate AS DISCOUNT_RATE, 
    item_discounted_total AS DISCOUNTED_TOTAL
