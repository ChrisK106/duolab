  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo $funciones->direct_paginas()."home" ?>" class="brand-link">
      <img src="<?php echo $funciones->direct_sistema(); ?>/img/DLLogo.png" alt="DuoLab Group" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo $funciones->direct_paginas()."clientes/registro-cliente" ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo $funciones->direct_paginas()."productos/mantenimiento-producto" ?>" class="nav-link">
          ...
          <li class="nav-item">
            <a href="<?php echo $funciones->direct_paginas()."proveedores/registro-proveedor" ?>" class="nav-link">
