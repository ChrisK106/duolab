            ...
            <div class="row mb-0">
                <div class="col-md-12">
                    <div class="m-0 text-dark text-center text-lg">
                        <i class="fas fa-file-invoice"></i>&nbsp;&nbsp;Resumen de Boletas
                    </div>
                </div>
            </div>
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <div class="row justify-content-end">
                            <div class="col-md-4">
                                <a href="registro-boleta" class="btn btn-success btn-block"><i class="fa fa-plus fa-1x"></i> Nueva Boleta</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="factura_numero" class="form-control" placeholder="Nro de boleta">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <button id="btn-buscar" class="btn btn-success btn-block" type="button">
                                   <i class="fa fa-search"></i>&nbsp;&nbsp;Buscar Boletas
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-boletas" class="table table-bordered table-hover" style="width: 100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Nro. Factura</th>
