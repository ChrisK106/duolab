            ...
            <div style="max-width: 1140px; margin: 0 auto;">
                <div class="row mb-3">
                    ...
                    <div id="col-btn-nuevafac" class="col-md-6">
                        <button type="button" id="btn-nuevafac" class="btn btn-primary btn-block"><i class="fa fa-plus fa-1x"></i>&nbsp;&nbsp;<font>Nuevo </font></button>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" class="form-control" name="facturacion_prodprecio" placeholder="" readonly>
                                </div>
                                <div class="col-md-2">
