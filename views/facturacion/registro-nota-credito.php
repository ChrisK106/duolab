    ...
    <div class="content">
        <div class="container-fluid">
            <div style="max-width: 1140px; margin: 0 auto;">
                ...
                <form id="FRM_INSERT_FACTURA" method="post" action="<?php echo $functions->direct_sistema(); ?>/modules/facturacion/insert-nota-credito.php" enctype="multipart/form-data">
