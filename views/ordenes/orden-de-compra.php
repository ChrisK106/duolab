    ...
    <div class="content">
        <div class="container-fluid">
        	<div style="max-width: 1140px; margin: 0 auto;">
	            ...
	            <form id="FRM_INSERT_DETA_ORDCOMPRA" method="post" action="<?php echo $funciones->direct_sistema(); ?>/modules/ordenes/insert-update-orden.php" enctype="multipart/form-data">
