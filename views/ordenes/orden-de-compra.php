    ...
    <div class="content">
        <div class="container-fluid">
        	<div style="max-width: 1140px; margin: 0 auto;">
	            ...
	            <form id="FRM_INSERT_DETA_ORDCOMPRA" method="post" action="<?php echo $functions->direct_sistema(); ?>/modules/ordenes/insert-update-orden.php" enctype="multipart/form-data">
	                    			...
	                    			<div class="row">
	                    				...
	                    				<div class="col-md-4">
	                    					<div class="input-group">
	                                            ...
	                                            <input type="text" class="form-control" placeholder="Número OC" name="orden_nro" readonly>
                                        	</div>
	                    				</div>
	                    			</div>
	                    		</div>
